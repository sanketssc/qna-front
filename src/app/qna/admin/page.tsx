  ...
  return (
    <div className="flex flex-col min-h-screen justify-between">
      <div className="flex flex-col w-full sm:w-4/5 mx-auto  gap-x-10 gap-y-5 max-h-[80vh] h-full overflow-y-auto p-2">
        <button
          className="w-3/5 text-center mx-auto bg-green-400 text-black rounded-md py-2"
          onClick={() => {
            socket.emit("deleteall", "delete all ques");
          }}
        >
          Reset Questions
        </button>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <button
                    className="bg-green-500 px-4 py-2 text-black disabled:bg-gray-600 border"
                    onClick={() => {
                      socket.emit("answered", { id: que.id });
                    }}
                  >
                    Ans
                  </button>
